                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group">
                            <input type="email" id="email" name="email" value="{{.Email}}" class="form-control text-left" placeholder="Enter your email address" />
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="form-actions">
                            <input class="btn btn-info" name="commit" type="submit" value="Send Reset Mail"/>
                        </div>
                    </div>
                </div>
            </form>
